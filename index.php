...
<div class="login-box">
  	<div class="login-logo">
  		<b>Pemilihan K3, K.Nora dan K.BK</b>
  	</div>
  
  	<div class="login-box-body">
    	<p class="login-box-msg">Login untuk memulai pemilihan</p>

    	<form action="login.php" method="POST">
      		<div class="form-group has-feedback">
        		<input type="text" class="form-control" name="voter" placeholder="NIP Anda ..." required>
